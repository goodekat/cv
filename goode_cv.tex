...
& Assisted with a research project on Bayesian neural networks (BNNs). Focused on visualizations of BNNs for assessment and explanations for prediction.\\
\\
...
& \emph{Iowa State University}\\
& Developed an R package that produces panels of diagnostic plots for one one, panels of plots for comparing multiple models, and interactive versions of the plots. Joint work with Kathleen Rey, Ph.D.. Source code can be found at \texttt{https://goodekat.github.io/ggResidpanel/}.
\end{longtable}
